	...
	public function actionView($c=null)
	{
        ...
        if (!empty($c)) {
            ...
            if ($qr_client->google_calendar_id) {
                ...
                //echo '<pre style="color:red; text-align:left; background:white; white-space: pre-wrap">' . print_r($service->settings->listSettings(), 1).'</pre><small>'.__FILE__.': '.__LINE__.'</small>';
                ...
                $events = $service->events->listEvents($qr_client->google_calendar_id);

                /* @var $event Google_Event */
                while(true) {
                ...
                //echo '<pre style="color:red; text-align:left; background:white; white-space: pre-wrap">' . print_r($service->calendars->get($qr_client->google_calendar_id), 1) . '</pre><small>' . __FILE__ . ': ' . __LINE__ . '</small>';
            }
        }
