			...
			<div class="col-md-7">
				...
				<div class="tab-content">
					<div class="tab-pane active" id="home<?php echo $data->id;?>">
						...
						//echo '<pre style="color:red; text-align:left; background:white; white-space: pre-wrap">' . print_r(urlencode('http://qrcaseapp.com/workflow/view&id=33&c=32'), 1).'</pre><small>'.__FILE__.': '.__LINE__.'</small>';
