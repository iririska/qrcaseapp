...
class Event {
	...
	public function __construct($array, $timezone=null) {
		...
		// Parse dates
		$this->start = self::parseDateTime($array['start'], $timezone);
		$this->end = isset($array['end']) ? self::parseDateTime($array['end'], $timezone) : null;
	...
	public function isWithinDayRange($rangeStart, $rangeEnd) {
		...
		$eventStart = self::stripTime($this->start);
		$eventEnd = isset($this->end) ? self::stripTime($this->end) : null;
