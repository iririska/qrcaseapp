...
class Client extends CActiveRecord
{
    ...
    protected function beforeValidate()
    {
        ...
        //creator_id
        //if superadmin creator client
        if (Yii::app()->user->checkAccess('superadmin') && empty($this->creator_id)){
            $this->creator_id = Yii::app()->user->id;
        }elseif (!Yii::app()->user->checkAccess('superadmin') && $this->isNewRecord){
            if(Yii::app()->user->checkAccess('user'))
                $this->creator_id = User::model()->findByPk(Yii::app()->user->id)->parent_id;
            else
                $this->creator_id = Yii::app()->user->id;
        }
