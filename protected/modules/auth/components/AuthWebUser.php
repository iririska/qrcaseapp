...
class AuthWebUser extends CWebUser
{
    ...
    {
        parent::init();
        $this->setIsAdmin( in_array($this->name, $this->admins) || $this->getState('__isAdmin', false) );
    }
    ...
    {
	    /*if ($operation == 'updateOwnData') {
		    //echo '<pre style="color:red; text-align:left; background:white; white-space: pre-wrap">' . $operation . print_r( $params, 1 ) . '</pre><small>' . __FILE__ . ': ' . __LINE__ . '</small>';
		    //exit;
	    }*/
