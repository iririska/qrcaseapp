...
EOD;
    ...
    {
	    //if ($attribute == 'date_start') echo '<pre style="color:red; text-align:left; background:white; white-space: pre-wrap">' . print_r($htmlOptions, 1).'</pre><small>'.__FILE__.': '.__LINE__.'</small>';
